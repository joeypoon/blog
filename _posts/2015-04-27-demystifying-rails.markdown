...
<h3>Tests</h3>
I have been trying to write <a href="http://joeypoon.com/blog/2015/04/14/on-the-road-to-testing/">my own tests</a> and doing a <a href="https://github.com/joeypoon/Summer_FA_Calculator">terrible job</a>. Rails makes testing so much easier. I'm just starting to grasp the amazing things I can do with
<pre>rake test</pre>
